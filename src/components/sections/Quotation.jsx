...
const Quotation = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const templateParams = { ...form, to_email: "cotizaciones@labmetrologia.com" };
    const result = await sendEmail(import.meta.env.VITE_EMAILJS_TEMPLATE_ID_COTIZACION, templateParams);
    if (result.success) {
